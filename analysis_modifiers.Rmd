...
# idee still has many obvious false hits, so we
# add a column that checks whether
# the word ends with the comparative suffix -er
idee$ends_with_er <- grepl("er(e|es|en)?$", idee$Key)
idee <- filter(idee, ends_with_er == TRUE)
